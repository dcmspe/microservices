...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        List<ObjectError> validationObjectErrorList = ex.getBindingResult().getAllErrors();

        validationObjectErrorList.forEach((error) -> {
            String fieldName = ((FieldError) error).getField();
            String validatingMessage = error.getDefaultMessage();
            errors.put(fieldName, validatingMessage);
        });
